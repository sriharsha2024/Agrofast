...
import 'package:flutterapp/agrofastapp/generatediphone11promax51widget/generated/GeneratedVectorWidget64.dart';
import 'package:flutterapp/agrofastapp/generatediphone11promax51widget/generated/GeneratedVectorWidget65.dart';

/* Instance Component 12
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedComponent12Widget3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () =>
          Navigator.pushNamed(context, '/GeneratedIPhone13ProMax23Widget'),
      child: Container(
        width: 18.0,
        height: 22.0,
        child: Stack(
